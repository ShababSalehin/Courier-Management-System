<!-- Navbar -->
  <nav class="main-header navbar navbar-expand navbar-primary navbar-dark ">
    ...
    <ul class="navbar-nav ml-auto">
	 	...
	 	<li class="nav-item">
	  <a class="nav-link" href="customer-display.php"><i class="fa fa-list-alt"></i> Customer Information</a>
	  </li>
	  
	  <li class="nav-item">
	  <a class="nav-link" href="delivery-display.php"><i class="fa fa-plane"></i> Delivery Information</a>
	  </li>
